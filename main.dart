...
void main() {
  ...
  // assignment score for final grade calculation.
  const double assignmentWeight = 0.2;
  // midterm score for final grade calculation.
  const double midtermWeight = 0.3;
  // final exam score for final grade calculation.
  const double finalExamWeight = 0.5;

  // User Input Collection 
  // enter the student's name.
  stdout.write('Enter student\'s name: ');
  // Read the student's name from standard input.
  ...
  print('----------------------------');
  // displaying the calculated final grade.
